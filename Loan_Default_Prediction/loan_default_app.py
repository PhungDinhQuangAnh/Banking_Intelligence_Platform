...
def run_loan_default_app():
    ...
    with st.form("input_form"):
        ...
        with tab2:
            ...
            with col2:
                HasDependents = st.selectbox("Có người thân phụ thuộc không? (Con cái, bố mẹ già,...) (Has Dependents)", ["Có", "Không"])
        ...
        with tab4:
            ...
            with col2:
                NumCreditLines = st.number_input("Số khoản vay/thẻ đang mở (Num Credit Lines)", min_value=1, max_value=4, value=2, step=1, icon=":material/credit_card:")
            with col3:
    ...
    if proba is not None:
        ...
        with res_col2:
            st.markdown(f"""
                <div style="background: #FFFFFF; border: 1px solid #E2E8F0; padding: 18px; border-radius: 16px; box-shadow: 0 4px 20px rgba(0, 0, 0, 0.04); font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Arial, sans-serif; margin-top: 15px; margin-right: 25px">
